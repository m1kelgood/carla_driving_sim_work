...
###############################################################################
# Following along with the development from sentdex (continued OOP)############
###############################################################################
...
class CarEnv:
    ...
    def reset(self):
        ...
        self.colsensor.listen(lambda event: self.colllision_data(event))
    ...
    def step(self, action):
        ...
        if self.start_start + SECONDS_PER_EPISODE < time.time():
            done = True
